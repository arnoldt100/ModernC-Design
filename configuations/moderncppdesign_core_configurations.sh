...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#                                                                 @
# ModernCPPDesign environmental variables.                        @
#                                                                 @
...
then
    ...
    echo "ModernCPPDesign will not build correctly till this variable is set."
else
    #-----------------------------------------------------
    # Define the top level of the moderncppdesign        -
    # program.                                           -
    #                                                    -
    #-----------------------------------------------------
    export MODERNCPPDESIGN_TOP_LEVEL_MD=${MODERNCPPDESIGN_TOP_LEVEL}
    ...
    #-----------------------------------------------------
    # Define the path to ModernCPPDesign cmake modules.  -
    #                                                    -
    # This variable is mandatory.                        -
    #-----------------------------------------------------
